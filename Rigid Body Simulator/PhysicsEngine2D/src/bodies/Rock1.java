...
public class Rock1 extends DynamicBody {

    public double Dimension;
    public final int VerticesNumber;
    public final int EdgesNumber;

    public Rock1(Vector x, Vector v, double Theta, double w, double mass, double Dimension, double inertia) {
        ...
        VerticesInit[0].x = Math.cos(Math.toRadians(60)) * this.Dimension * 2 * 0.3;
        VerticesInit[0].y = Math.sin(Math.toRadians(60)) * this.Dimension * 2 * 0.3;
        
        VerticesInit[1] = new Vector();

        VerticesInit[1].x = Math.cos(Math.toRadians(120)) * this.Dimension * 2.3 * 0.3;
        VerticesInit[1].y = Math.sin(Math.toRadians(120)) * this.Dimension * 2.3 * 0.3;
        
        VerticesInit[2] = new Vector();

        VerticesInit[2].x = Math.cos(Math.toRadians(180)) * this.Dimension * 2.9 * 0.3;
        VerticesInit[2].y = Math.sin(Math.toRadians(180)) * this.Dimension * 2.9 * 0.3;
        
        VerticesInit[3] = new Vector();

        VerticesInit[3].x = Math.cos(Math.toRadians(240)) * this.Dimension * 2.33 * 0.3;
        VerticesInit[3].y = Math.sin(Math.toRadians(240)) * this.Dimension * 2.33 * 0.3;
        
        VerticesInit[4] = new Vector();

        VerticesInit[4].x = Math.cos(Math.toRadians(300)) * this.Dimension * 1.9 * 0.3;
        VerticesInit[4].y = Math.sin(Math.toRadians(300)) * this.Dimension * 1.9 * 0.3;
        
        VerticesInit[5] = new Vector();

        VerticesInit[5].x = Math.cos(Math.toRadians(0)) * this.Dimension * 1.9 * 0.3;
        VerticesInit[5].y = Math.sin(Math.toRadians(0)) * this.Dimension * 1.9 * 0.3;
