...
public class Rock2 extends DynamicBody {

    public double Dimension;
    public final int VerticesNumber;
    public final int EdgesNumber;

    public Rock2(Vector x, Vector v, double Theta, double w, double mass, double Dimension, double inertia) {
        ...
        VerticesInit[0].x = Math.cos(Math.toRadians(25)) * this.Dimension * 2 * 0.3;
        VerticesInit[0].y = Math.sin(Math.toRadians(25)) * this.Dimension * 2 * 0.3;
        
        VerticesInit[1] = new Vector();

        VerticesInit[1].x = Math.cos(Math.toRadians(100)) * this.Dimension * 2.3 * 0.3;
        VerticesInit[1].y = Math.sin(Math.toRadians(100)) * this.Dimension * 2.3 * 0.3;
        
        VerticesInit[2] = new Vector();

        VerticesInit[2].x = Math.cos(Math.toRadians(160)) * this.Dimension * 2.9 * 0.3;
        VerticesInit[2].y = Math.sin(Math.toRadians(160)) * this.Dimension * 2.9 * 0.3;
        
        VerticesInit[3] = new Vector();

        VerticesInit[3].x = Math.cos(Math.toRadians(-125)) * this.Dimension * 2.33 * 0.3;
        VerticesInit[3].y = Math.sin(Math.toRadians(-125)) * this.Dimension * 2.33 * 0.3;
        
        VerticesInit[4] = new Vector();

        VerticesInit[4].x = Math.cos(Math.toRadians(-50)) * this.Dimension * 1.9 * 0.3;
        VerticesInit[4].y = Math.sin(Math.toRadians(-50)) * this.Dimension * 1.9 * 0.3;
        
        VerticesInit[5] = new Vector();

        VerticesInit[5].x = Math.cos(Math.toRadians(-5)) * this.Dimension * 1.9 * 0.3;
        VerticesInit[5].y = Math.sin(Math.toRadians(-5)) * this.Dimension * 1.9 * 0.3;
        ...
        Color = new Triple(0.8627, 0.3176, 0.0);
