...
public class Rectangle extends DynamicBody {
    ...
    public Rectangle(Vector x, Vector v, double Theta, double w, double mass, double Width, double Hieght, double inertia) {
        ...
        VerticesInit[0].x = 0.5f * this.Width;
        VerticesInit[0].y = 0.5f * this.Hieght;

        VerticesInit[1] = new Vector();

        VerticesInit[1].x = -0.5f * this.Width;
        VerticesInit[1].y = 0.5f * this.Hieght;

        VerticesInit[2] = new Vector();

        VerticesInit[2].x = -0.5f * this.Width;
        VerticesInit[2].y = -0.5f * this.Hieght;

        VerticesInit[3] = new Vector();

        VerticesInit[3].x = 0.5f * this.Width;
        VerticesInit[3].y = -0.5f * this.Hieght;
